...
if($_REQUEST['map'] == 'Y'){
	unset($arDefaultUrlTemplates404['template']);
	$arDefaultUrlTemplates404['template_map'] = 'index.php';
}
...
else
{
	...
	$arResult = array(
		"FOLDER" => "",
		"URL_TEMPLATES" => Array(
			"dtp" => htmlspecialcharsbx($APPLICATION->GetCurPage()),
